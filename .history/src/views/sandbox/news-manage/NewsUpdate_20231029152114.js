...
const mapStateToProps = ({setCurrentUserReducer:{region,username,roleId},getCategories:{categories}}) => {
  // console.log(state)
  return {
...
export default connect()() withRoute(NewsUpdate) 
