...
export default function RoleList() {
  ...
  useEffect(()=>{
    axios.get('/api/rolelist').then(res=>{
      console.log(res.data[0].rolelist)

      console.log(JSON.parse(JSON.stringify(res.data[0].rolelist)))
      console.log(typeof(JSON.parse(JSON.stringify(res.data[0].rolelist))))
