...
[
    ...
    [
    {"id":1,"roleType":1,"roleName":"超级管理员","rights":"\/right-manage\/role\/update,\/right-manage\/role\/delete,\/right-manage\/right\/update,\/right-manage\/right\/delete,\/audit-manage,\/audit-manage\/audit,\/audit-manage\/list,\/right-manage,\/right-manage\/role\/list,\/right-manage\/right\/list,\/news-manage\/list,\/news-manage\/update\/:id,\/news-manage\/preview\/:id,\/news-manage\/draft,\/news-manage\/category,\/news-manage,\/user-manage\/add,\/user-manage\/delete,\/user-manage\/update,\/user-manage\/list,\/user-manage,\/publish-manage\/unpublished,\/publish-manage\/published,\/publish-manage\/sunset,\/publish-manage,\/home,\/news-manage\/add"},
    {"id":2,"roleType":2,"roleName":"区域管理员","rights":"\/audit-manage,\/audit-manage\/audit,\/audit-manage\/list,\/news-manage\/list,\/news-manage\/add,\/news-manage\/update\/:id,\/news-manage\/preview\/:id,\/news-manage\/draft,\/news-manage\/category,\/news-manage,\/user-manage\/list,\/user-manage,\/home,\/publish-manage\/unpublished,\/publish-manage\/published,\/publish-manage\/sunset,\/publish-manage"},
    {"id":3,"roleType":3,"roleName":"区域编辑","rights":"\/audit-manage,\/audit-manage\/list,\/news-manage\/list,\/news-manage\/add,\/news-manage\/update\/:id,\/news-manage\/preview\/:id,\/news-manage\/draft,\/news-manage,\/home"}
    ]
    }
    ]
